...
function my_theme_enqueue_styles() {
    ...
    wp_enqueue_script( 'child_scripts', get_theme_file_uri().'/assets/js/child-scripts.js', '', '1.0.12', true);
    wp_enqueue_style( 'child-style', get_stylesheet_directory_uri() . '/style.css', '' , '1.0.12', false);
}
...
function modifiedDate_func(){
	if(!is_page(array(169, 165, 162, 238, 66, 81, 158, 209, 122, 117, 74, 623))) {
		?>
