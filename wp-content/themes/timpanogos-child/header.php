...
<html <?php language_attributes();?>>
	<head>
		<!-- Global site tag (gtag.js) - Google Analytics -->
			<script async src="https://www.googletagmanager.com/gtag/js?id=UA-130781213-6"></script>
			<script>
			  window.dataLayer = window.dataLayer || [];
			  function gtag(){dataLayer.push(arguments);}
			  gtag('js', new Date());
			
			  gtag('config', 'UA-130781213-6');
			</script>
			...
			<h1><?php echo get_bloginfo( 'name') ?></h1>
				...
				<aside>
					<ul class="sociallinks">
						<li><a href="https://www.instagram.com/timpanogos_elementary/"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-instagram-white.svg' ?>" alt="Link to Instagram" /></span>
							</a>
						</li>
						<li><a href="https://twitter.com/TimpTigers"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-twitter-white.svg' ?>" alt="Link to Twitter" /></span>
							</a>
						</li>
						<li><a href="https://www.facebook.com/timpanogoselementary"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-facebook-white.svg' ?>" alt="Link to Facebook" /></span>
							</a>
						</li>
					</ul>
					<!-- Search Form -->
					...
					<ul class="contactinfo" itemscope itemtype="https://schema.org/PostalAddress">
						<li><span itemprop="streetAddress">449 North 500 West</span><span itemprop="addressLocality"> Provo</span>, <span itemprop="addressRegion">Utah</span> <span itemprop="postalCode">84601</span><span class="phone" itemprop="telephone"> Phone: (801) 374-4955</span><span class="fax" itemprop="faxNumber"> Fax: (801) 374-4958</span>
					</ul>
